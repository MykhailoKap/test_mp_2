...
***************************************************************************** */
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("navigation__button") && !targetElement.classList.contains("_active")) {
                const activeElement = document.querySelector(".navigation__button._active");
                const elements = document.querySelectorAll(`.body-gallery__image`);
